...
export const landingsEn: LandingsBundle = {
  bages: {
    ...
    hero: {
      ...
      ctaPrimary: { label: "Check availability", route: "reservar" },
    ...
    finalCta: {
      ...
      paragraphs: [
        "Check available dates and discover Cal Masses as a starting point for a few days in the region.",
      ],
      primary: { label: "Check availability", route: "reservar" },
    ...
    internalLinks: [
      ...
      { label: "Check availability", route: "reservar" },
    ],
  },
  ...
  manresa: {
    ...
    finalCta: {
      ...
      paragraphs: [
        ...
        "Check available dates and decide the rest of the trip afterwards.",
      ],
      primary: { label: "Check availability", route: "reservar" },
    },
    related: [
  ...
  montserrat: {
    ...
    finalCta: {
      ...
      paragraphs: [
        "Check available dates and discover everything you can do from Cal Masses.",
      ],
      primary: { label: "Check availability", route: "reservar" },
    },
    related: [
  ...
  paraDos: {
    ...
    finalCta: {
      ...
      paragraphs: ["Check available dates and discover Cal Masses."],
      primary: { label: "Check availability", route: "reservar" },
    },
    related: [
  ...
  barcelona: {
    ...
    sections: [
      ...
      },
      {
        ...
        cta: { label: "Check availability", route: "reservar" },
      },
    ],
    finalCta: {
      h2: "You do not need to fill the weekend",
